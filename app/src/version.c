...
const uint32_t fwinfoBuild    = 475;
const char fwinfoVersion[] = {"1.0.0.475"};
const char fwinfoDate[]    = {"04.08.2017"};
const char fwinfoTime[]    = {"22:54:54"};
