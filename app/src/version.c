...
const uint32_t fwinfoBuild    = 484;
const char fwinfoVersion[] = {"1.0.0.484"};
const char fwinfoDate[]    = {"05.08.2017"};
const char fwinfoTime[]    = {"02:55:14"};
