...
const uint32_t fwinfoBuild    = 553;
const char fwinfoVersion[] = {"1.0.0.553"};
const char fwinfoDate[]    = {"06.08.2017"};
const char fwinfoTime[]    = {"23:34:48"};
