...
const uint32_t fwinfoBuild    = 316;
const char fwinfoVersion[] = {"1.0.0.316"};
const char fwinfoDate[]    = {"31.07.2017"};
const char fwinfoTime[]    = {"22:52:19"};
