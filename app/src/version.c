...
const uint32_t fwinfoBuild    = 678;
const char fwinfoVersion[] = {"1.0.0.678"};
const char fwinfoDate[]    = {"08.08.2017"};
const char fwinfoTime[]    = {"23:22:56"};
