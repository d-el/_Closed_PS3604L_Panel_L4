...
const uint32_t fwinfoBuild    = 406;
const char fwinfoVersion[] = {"1.0.0.406"};
const char fwinfoDate[]    = {"03.08.2017"};
const char fwinfoTime[]    = {"02:04:30"};
