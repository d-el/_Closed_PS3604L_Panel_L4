...
const uint32_t fwinfoBuild    = 324;
const char fwinfoVersion[] = {"1.0.0.324"};
const char fwinfoDate[]    = {"02.08.2017"};
const char fwinfoTime[]    = {"02:44:07"};
