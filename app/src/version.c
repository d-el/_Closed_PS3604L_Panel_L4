...
const uint32_t fwinfoBuild    = 312;
const char fwinfoVersion[] = {"1.0.0.312"};
const char fwinfoDate[]    = {"28.07.2017"};
const char fwinfoTime[]    = {"01:06:19"};
