...
/*0 */makepin(GPIOB, 3, 	digitalInput, 	pullUp, 		0, 0), //bMode
/*1 */makepin(GPIOA, 4, 	digitalInput, 	pullUp, 		0, 0), //bOnOff
/*2 */makepin(GPIOA, 15, 	digitalInput, 	pullUp, 		0, 0), //bView
/*3 */makepin(GPIOB, 1, 	digitalInput, 	pullUp, 		0, 0), //bNext
/*4 */makepin(GPIOA, 12, 	digitalInput, 	pullUp, 		0, 0), //bZero
/*5 */makepin(GPIOA, 11, 	digitalInput, 	pullUp, 		0, 0), //bUp
/*6 */makepin(GPIOA, 10, 	digitalInput, 	pullUp, 		0, 0), //bDown
/*7 */makepin(GPIOB, 9, 	outPushPull, 	pullDisable, 	0, 0), //LED
/*8 */makepin(GPIOB, 8, 	digitalInput, 	pullUp, 		0, 0), //GPIO0
/*9 */makepin(GPIOB, 5, 	digitalInput, 	pullUp, 		0, 0), //GPIO1
/*10*/makepin(GPIOB, 4, 	outPushPull, 	pullDisable, 	0, 0), //GPIO2
